...
def plotRatio(var, dir, inFileData1, name1, inFileData2, name2, xTitle, outDir, rTitle="Ratio",setLogy=0,binning=1):
...
def makeInverseTurnOnAll(name,var,dir,inFile1,name1,inFile2,name2,binning, otherText, outDir, wps=["Loose","Medium","Tight"],colors=[ROOT.kRed,ROOT.kGreen,ROOT.kBlue]):
    ...
    leg  = ROOT.TLegend(xpos, ypos, xpos+xwidth, ypos+ywidth)
    leg2 = ROOT.TLegend(xpos+0.3, ypos, xpos+xwidth+0.3, ypos+ywidth)
