...
for v in vars:
    ...
    if v in ["HasInnerPixHit","IsFromV0","IsFromSV","NPixelHits","NStripHits","NTotalHits","algo","origAlgo","PV","charge"]:
        binning = 1
    ...
    fake_Matched_1   = makeEff(v ,    [fakeNumName,  fakeDenName],inFile1,  binning=binning)
    fake_Matched_2   = makeEff(v ,    [fakeNumName,  fakeDenName],inFile2,  binning=binning)
