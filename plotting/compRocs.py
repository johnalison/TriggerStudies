...
p = OptionParser()
p.add_option('--input1',  type = 'string', default = "outBTag.FTKBtagging.ttbar.mwt2.All.root", dest = 'inFile1', help = 'intput File' )
p.add_option('--input2',  type = 'string', default = "outBTag.FTKBtagging.ttbar.mwt2.All.root", dest = 'inFile2', help = 'intput File' )
...
def makeRocPlot(inFile, name, var, bkg, sig, dir, varNorm=None,debug=False):
    ...
    for config in [("Rej",1,5e4),("Eff",5e-4,1)]:
        rocPlots.append(makeRoc(sigHist, sigNormHist, bkgHist, bkgNormHist,doErr=True,bkgMode=config[0],cleanNoCut=True,debug=debug))
...
def main():
    ...
    calo_deepcsv_roc_1   = makeRocPlot(inFile1, "Calo_deepcsv",  "DeepCSV_l",  bkg="matchedCaloJet_L",sig="matchedCaloJet_B",dir="offJets")
    calo_deepcsv_roc_2   = makeRocPlot(inFile2, "Calo_deepcsv",  "DeepCSV_l",  bkg="matchedCaloJet_L",sig="matchedCaloJet_B",dir="offJets")

    off_deepcsv_roc_1   = makeRocPlot(inFile1, "Offline_deepcsv", "DeepCSV_l", bkg="matched_L",sig="matched_B",dir="offJets")
    off_deepcsv_roc_2   = makeRocPlot(inFile2, "Offline_deepcsv", "DeepCSV_l", bkg="matched_L",sig="matched_B",dir="offJets")
    ...
    pf_deepcsv_roc_1   = makeRocPlot(inFile1, "PF_deepcsv",     "DeepCSV_l", bkg="matchedJet_L",sig="matchedJet_B",dir="offJets")
    pf_deepcsv_roc_2   = makeRocPlot(inFile2, "PF_deepcsv",     "DeepCSV_l", bkg="matchedJet_L",sig="matchedJet_B",dir="offJets")
...
#                 )
        ...
        plotSame("Off_vs_HLTDeepCSV_"+rocType,
                 [off_deepcsv_roc_1[i], calo_deepcsv_roc_1[i], pf_deepcsv_roc_1[i], off_deepcsv_roc_2[i], calo_deepcsv_roc_2[i], pf_deepcsv_roc_2[i]], 
                 [ROOT.kBlack,       ROOT.kRed  ,      ROOT.kBlue, ROOT.kBlack,       ROOT.kRed  ,      ROOT.kBlue],
                 [ROOT.kSolid,      ROOT.kSolid,      ROOT.kSolid, ROOT.kDashed,      ROOT.kDashed,     ROOT.kDashed],
                 plotCaloJet = True,
                 plotPFJet = True,
                 plotOffJet = True,
                 plotCSV = False,
