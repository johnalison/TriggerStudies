...
class JetHists:
    ...
    def __init__(self,name, outFile):
        ...
        self.trackSumJetEtRatio               = self.makeHist('trackSumJetEtRatio'           ,'trackSumJetEtRatio;#{Sum} Track/Jet E_{T} Ratio'            ,100, -0.1,1.5)
        self.trackSumJetDeltaR                = self.makeHist('trackSumJetDeltaR'            ,'trackSumJetDeltaR; #{Sum} Track-Jet #Delta R'             ,100, -0.1, 2)
        ...
        self.trackSip3dSigAboveCharm          = self.makeHist('trackSip3dSigAboveCharm'      ,'trackSip3dSigAboveCharm;trackSip3dValAboveCharm'       ,100, -50, 50)
